...
public class TestGame {
	...
	public static void main(String[] args) {
		...
		// Cr�ation de l'entit� repr�sentant le joueur 1
		engine.addPlayer(0);
		...
		// Cr�ation de l'entit� repr�sentant le joueur 2
		engine.addPlayer(1);
		...
		// Cr�ation de l'interface du menu de jeu
		engine.setInterfaceAmount(2);
		engine.addInterface(1);
		Interface menu = new Interface();
		engine.replaceInterface(1, menu);

		// Cr�ation d'un bouton Permettant de quitter le jeu
		engine.addButton(3);
		...
		// Cr�ation d'un bouton Permettant de lancer le jeu ou de quitter la
		// pause
		engine.addButton(4);
		...
		// Cr�ation d'un bouton pour tester l'utilisation de boutons repr�sent�s
		// par des images
		engine.addButton(5);
		...
		// D�finition de la repr�sentation du curseur par d�faut et du curseur
		// de click
		engine.cursor.setCursorSprite(engine.Sprite(6));
		engine.cursor.setClickSprite(engine.Sprite(7));

		// Cr�ation d'un d�lai �liminant des erreurs dans l'activation du menu
		// de jeu
